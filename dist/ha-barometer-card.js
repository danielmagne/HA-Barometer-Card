        ...
        ${e?I`
            ...
            `:I`
              <ha-textfield
                ...
                .value=${t.entity??""}
                @change=${t=>this._handleEntityChanged({stopPropagation(){},detail:{value:t.currentTarget.value}})}
              ></ha-textfield>
            `}
